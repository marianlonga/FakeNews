...
data['num_urls_nonzero'] = data['num_urls'].apply(lambda number: number >= 1)
data['num_media_nonzero'] = data['num_media'].apply(lambda number: number >= 1)
data['num_hashtags_nonzero'] = data['num_hashtags'].apply(lambda number: number >= 1)
data['num_mentions_more_than_2'] = data['num_hashtags'].apply(lambda number: number > 2)
...
if DO_STATISTICS:
    statistics_features = [
        ...
        'text_num_swears',
        'num_urls_nonzero', 'num_hashtags_nonzero', 'num_mentions_more_than_2',
