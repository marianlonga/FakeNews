# (c) 2017 Marian Longa
# v2: add upsampling of fake news data
...
data_real = data[data.real == 1] #print "data_real shape: ", data_real.shape[0]
data_fake = data[data.real == 0] #print "data_fake shape: ", data_fake.shape[0]
...
print(data_upsampled.real.value_counts())

print("@@@@@@@@")

#sys.exit()

y_original, X_original = dmatrices('real ~ retweet_count + user_verified + user_friends_count + user_followers_count + user_favourites_count + num_hashtags + num_mentions + num_urls + num_media', data, return_type='dataframe')
y_upsampled, X_upsampled = dmatrices('real ~ retweet_count + user_verified + user_friends_count + user_followers_count + user_favourites_count + num_hashtags + num_mentions + num_urls + num_media', data_upsampled, return_type='dataframe')
